    ...
    $('#botao_pesquisar_grafico').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(receber1, function (y, item1) {
                    receber_meses1.push(y);
                    receber_valores1.push(item1);
                });

                var dados = {
                    labels: receber_meses, receber_meses1,
                    datasets: [{
